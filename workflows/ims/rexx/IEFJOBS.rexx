...
/*------------------------------------------------------------*/
proclib = '${instance-zCloud_PROCLIB}'
todsn = '${instance-zCloud_IEFJOBS}'
user = '${instance-DFS_IMS_USERID}'
imsid = '${instance-DFS_IMS_SSID}'
useIEFJOBS = '${instance-DFS_useIEFJOBS}'
...
/*------------------------------------------------------------*/
procnm.0 = 6
procnm.1 = ${instance-DFS_IMS_SSID}CTL
procnm.2 = ${instance-DFS_IMS_SSID}DLI
procnm.3 = ${instance-DFS_IMS_SSID}DRC
procnm.4 = ${instance-DFS_IMS_SSID}OM
procnm.5 = ${instance-DFS_IMS_SSID}SC
procnm.6 = ${instance-DFS_IMS_SSID}RM
