...
//SYSIN80  DD DISP=(NEW,DELETE),DSN=${instance-DFS_AUTH_LIB_HLQ1}.${instance-DFS_AUTH_LIB_HLQ2}.SYSIN,
//            UNIT=${instance-DFS_IMS_UNIT},SPACE=(CYL,(5,5)),
//            DCB=(RECFM=FB,LRECL=80,BLKSIZE=11440,DSORG=PS)
//SYSUT1   DD UNIT=${instance-DFS_IMS_UNIT},SPACE=(CYL,(5,5))
//SYSLIN   DD DISP=(NEW,DELETE),DSN=${instance-DFS_AUTH_LIB_HLQ1}.${instance-DFS_AUTH_LIB_HLQ2}.SYSLIN,
//            UNIT=${instance-DFS_IMS_UNIT},SPACE=(CYL,(1,5)),
//            DCB=(RECFM=FB,LRECL=80,BLKSIZE=11440,DSORG=PS)
//SYSPRT80 DD DISP=(NEW,DELETE),DSN=${instance-DFS_AUTH_LIB_HLQ1}.${instance-DFS_AUTH_LIB_HLQ2}.SYSPRT,
//            UNIT=${instance-DFS_IMS_UNIT},SPACE=(CYL,(5,5)),
