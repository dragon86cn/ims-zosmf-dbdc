...
SSN=CQS1                /* CQS SUBSYSTEM NAME (CQSID = CQS1CQS)     */
...
STRUCTURE (
  STRNAME=QMSGIMS01,
  CHKPTDSN=${instance-DFS_AUTH_LIB_HLQ1}.${instance-DFS_AUTH_LIB_HLQ2}.MSGQ.CHKPT,
  SYSCHKPT=50000)
...
STRUCTURE (
  STRNAME=QEMHIMS01,
  CHKPTDSN=${instance-DFS_AUTH_LIB_HLQ1}.${instance-DFS_AUTH_LIB_HLQ2}.EMHQ.CHKPT,
  SYSCHKPT=50000)
*--------------------------------------------------------------------*
...
STRUCTURE (
  ...
  SRDSDSN1=${instance-DFS_AUTH_LIB_HLQ1}.${instance-DFS_AUTH_LIB_HLQ2}.MSGQ.SRDS1,
  SRDSDSN2=${instance-DFS_AUTH_LIB_HLQ1}.${instance-DFS_AUTH_LIB_HLQ2}.MSGQ.SRDS2,
...
STRUCTURE (
  ...
  SRDSDSN1=${instance-DFS_AUTH_LIB_HLQ1}.${instance-DFS_AUTH_LIB_HLQ2}.EMHQ.SRDS1,
  SRDSDSN2${instance-DFS_AUTH_LIB_HLQ1}.${instance-DFS_AUTH_LIB_HLQ2}.EMHQ.SRDS2,
