...
OMNAME=${instance-DFS_IMS_SSID}OM,     /* OM NAME (OMID = OMOM)   */
IMSPLEX(
  NAME=${instance-DFS_IMSPlex},                  /* IMSPLEX NAME (CSLPLEX1)           */
  AUDITLOG=SYSLOG.OM2Q01.LOG), /* MVS LOG STREAM                    */
CMDTEXTDSN=${instance-DFS_AUTH_LIB_HLQ}.${instance-DFS_AUTH_LIB_SYSHLQ2}.SDFSDATA /* CMD TEXT DATASET            */
...
RMNAME=${instance-DFS_IMS_SSID}RM,        /* RM NAME (RMID = RMRM) */
IMSPLEX(NAME=${instance-DFS_IMSPlex})            /* IMSPLEX NAME (CSLPLEX1)           */
...
SCINAME=${instance-DFS_IMS_SSID}SC,  /* SCI NAME (SCIID = SCSCI) */
IMSPLEX(NAME=${instance-DFS_IMSPlex})           /* IMSPLEX NAME (CSLPLEX1)            */
...
//*
//*********************************************************************
//${instance-DFS_IMS_SSID}RM EXEC PROC=PROCUPDT,MBR=${instance-DFS_IMS_SSID}RM
...
//        'ARMRST=N','RMNAME=${instance-DFS_IMS_SSID}RM')
//*
...
//*
//*
//${instance-DFS_IMS_SSID}SC EXEC PROC=PROCUPDT,MBR=${instance-DFS_IMS_SSID}SC
//P.SYSUT1 DD DATA,DLM=$$
//*------------------------------------------------------------------*
//*   SCI                                                            *
//*------------------------------------------------------------------*
...
//            'ARMRST=N','SCINAME=${instance-DFS_IMS_SSID}SC')
//*
//STEPLIB  DD  DSN=${instance-DFS_AUTH_LIB_HLQ1}.${instance-DFS_AUTH_LIB_HLQ2}.SDFSRESL,DISP=SHR
//*
//PROCLIB  DD  DSN=${instance-DFS_AUTH_LIB_HLQ1}.${instance-DFS_AUTH_LIB_HLQ2}.PROCLIB,DISP=SHR
...
//*
//*
//${instance-DFS_IMS_SSID}OM EXEC PROC=PROCUPDT,MBR=${instance-DFS_IMS_SSID}OM
//P.SYSUT1 DD DATA,DLM=$$
//*------------------------------------------------------------------*
//*   OM                                                             *
//*------------------------------------------------------------------*
...
//        'ARMRST=N','CMDSEC=N','OMNAME=${instance-DFS_IMS_SSID}OM')
//*
//STEPLIB  DD  DSN=${instance-DFS_AUTH_LIB_HLQ1}.${instance-DFS_AUTH_LIB_HLQ2}.SDFSRESL,DISP=SHR
//*
//PROCLIB  DD  DSN=${instance-DFS_AUTH_LIB_HLQ1}.${instance-DFS_AUTH_LIB_HLQ2}.PROCLIB,DISP=SHR
...
IMSPLEX=${instance-DFS_IMSPlex}                    /* IMSPLEX NAME                    */
...
RDDSDSN=(
  ${instance-DFS_AUTH_LIB_HLQ1}.${instance-DFS_AUTH_LIB_HLQ2}.RDDS1,
  ${instance-DFS_AUTH_LIB_HLQ1}.${instance-DFS_AUTH_LIB_HLQ2}.RDDS2,
  ${instance-DFS_AUTH_LIB_HLQ1}.${instance-DFS_AUTH_LIB_HLQ2}.RDDS3)
*
*--------------------------------------------------------------------*
