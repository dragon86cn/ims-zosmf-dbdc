...
TCPIP=(HOSTNAME=TCPIP,PORTID=(99${instance-DFS_PORTIDSuf},98${instance-DFS_PORTIDSuf},LOCAL),RACFID=SYS1,TIMEOUT=5000,
IPV6=Y,SSLPORT=(88${instance-DFS_PORTIDSuf}),SSLENVAR=HWSDPSSL,MAXSOC=600,
...
ODACCESS=(ODBMAUTOCONN=Y,IMSPLEX=(MEMBER=HWS1,TMEMBER=${instance-DFS_IMSPlex}),
     DRDAPORT=(ID=55${instance-DFS_PORTIDSuf},PORTTMOT=6000),ODBMTMOT=6000)
/*
//***************************************************************
//***************************************************************
...
**                                                                **
********************************************************************
ODBMNAME=${instance-DFS_IMS_SSID}OD${instance-DFS_PORTIDSuf}
