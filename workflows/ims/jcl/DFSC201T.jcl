...
*
         IMSCTRL  SYSTEM=(VS/2,(ALL,DB/DC),390),                       X
               IRLM=NO,                                                X
               IRLMNM=${instance-DXR_IRLM_SSID},                                            X
               CMDCHAR=${instance-DFS_IMS_CRC},                                              X
               DBRCNM=${instance-DFS_IMS_SSID}DRC,                                         X
               DLINM=${instance-DFS_IMS_SSID}DLI,                                          X
               DCLWA=YES,                                              X
               IMSID=${instance-DFS_IMS_SSID},                                             X
               NAMECHK=(YES,S1),                                       X
...
*           SYSTEMS.
         COMM RECANY=(5,4096),                                         X
               APPLID=${instance-IST_VTAM_IMSAPPLID},                                          X
               PASSWD=${instance-IST_VTAM_IMSAPPLID},                                          X
...
*
         IMSGEN ASM=(HLASM,SYSLIN),ASMPRT=OFF,                         X
               ...
               SUFFIX=I,                                               X
               SURVEY=YES,                                             X
               NODE=(${instance-DFS_AUTH_LIB_HLQ1}.${instance-DFS_AUTH_LIB_HLQ2},                                    X
               ${instance-DFS_AUTH_LIB_HLQ1}.${instance-DFS_AUTH_LIB_HLQ2},                                          X
               ${instance-DFS_AUTH_LIB_HLQ1}.${instance-DFS_AUTH_LIB_HLQ2}),                                         X
               OBJDSET=${instance-DFS_AUTH_LIB_HLQ1}.${instance-DFS_AUTH_LIB_HLQ2}.OBJDSET,                          X
               PROCLIB=YES,                                            X
               USERLIB=${instance-DFS_AUTH_LIB_HLQ1}.${instance-DFS_AUTH_LIB_HLQ2}.SDFSRESL,                         X
               UMAC0=,                                                 X
               MACSYS=${instance-zCloud_MACLIB},                                     X
               MODGEN=${instance-zCloud_MODGEN},                                     X
               SCEERUN=${instance-zCloud_LERuntime},                                    X
               UMAC1=,                                                 X
               UMAC2=,                                                 X
               UMAC3=,                                                 X
               ONEJOB=(YES,YES),                                       X
